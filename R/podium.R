...
podium.challenge=function(object, 
  ...
  dat=as.data.frame(table(ranking$mat[[attr(object,"algorithm")]],
                          ranking$mat$rank,
                          dnn=c("algorithm","rank")),
                    responseName = "Count")

  form=as.formula(paste(attr(object,"case"),attr(object,"algorithm"),sep="~"))
  ranks=acast(ranking$mat,form,value.var= "rank")
  values=acast(object,form,value.var= attr(object,"value"))
  ...
  ylim=range(object[[attr(object,"value")]], na.rm = TRUE)
