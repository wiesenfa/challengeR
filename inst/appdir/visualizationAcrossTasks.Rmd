...
```{r, child=if (isMultiTask && bootstrappingEnabled) 'characterizationOfAlgorithmsBootstrapping.Rmd'}
...
```{r, child=if (isMultiTask && bootstrappingEnabled) 'characterizationOfTasksBootstrapping.Rmd'}
