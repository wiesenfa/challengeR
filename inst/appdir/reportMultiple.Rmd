...
```{r, child=if (!isMultiTask && !bootstrappingEnabled) './inst/appdir/overviewSingleTaskNoBootstrapping.Rmd'}

```

```{r, child=if (!isMultiTask && bootstrappingEnabled) './inst/appdir/overviewSingleTaskBootstrapping.Rmd'}

```

```{r, child=if (isMultiTask && !bootstrappingEnabled) './inst/appdir/overviewMultiTaskNoBootstrapping.Rmd'}

```

```{r, child=if (isMultiTask && bootstrappingEnabled) './inst/appdir/overviewMultiTaskBootstrapping.Rmd'}
...
```{r, child=if (isMultiTask) './inst/appdir/consensusRanking.Rmd'}
...
```{r, child=if (bootstrappingEnabled) './inst/appdir/visualizationBlobPlots.Rmd'}

```

```{r, child=if (bootstrappingEnabled) './inst/appdir/visualizationViolinPlots.Rmd'}
...
```{r, child=if (isMultiTask) './inst/appdir/visualizationAcrossTasks.Rmd'}
