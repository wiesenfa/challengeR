...
legend.height = nrow.legend* max( cex.legend * par()$cin[2],max(strheight(algs, units = "inches", cex = cex.legend)))   
...
if (oh>0) par(omi=c(legend.height+grconvertY(3, from="lines",to='inches'),0,0,0))
